                        ...
                        <form onSubmit={handleSubmit(handleSubmitForm)}>
                            ...
                            <div className='email-form__container'>
                                ...
                                <input
                                    ...
                                    type="email"
                                    name='Email'
                                    placeholder='funnytvvn@gmail.com'
                                    {...register('Email', {
                                        minLength: '5',
                                        maxLength: '100',
                            ...
                            <div className='message-form__container'>
                                <label htmlFor="message-input">Nội Dung Tin Nhắn</label>
                                <textarea
                                    name="Message"
                                    id="message-input"
                                    placeholder='Tôi có thắc mắc này muốn hỏi bạn?'
